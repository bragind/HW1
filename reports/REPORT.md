...
График сохранён в `reports/figures/top_tags.png`.
...
Графики EDA сохранены в каталоге `reports/figures/`:
- `ratings_distribution.png` — распределение оценок
- `user_activity.png` — количество пользователей и количество оценок
- `book_popularity.png` — количество книг vs количество оценок
- `top_tags.png` — топ тегов
